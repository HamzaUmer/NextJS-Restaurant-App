...
const Cart = () => {
    ...
    const createOrder =  async (data) => {
        try{
           const res =  await axios.post('https://next-js-restaurant-app.vercel.app/api/orders', data);
        ...
        <div className={styles.container}>
            ...
            <div className={styles.right}>
                ...
                {open ? (
                    ...
                    <PayPalScriptProvider
                    options={{
                        "client-id": "Acdv_6SyeAUkdKaPUBEDqBoNcQ6dctZLOfG989mLg5vWtNied_Plq9Kw8faIMt2ef1MYPfFMputT-YT7",
                        components: "buttons",
                        currency: "USD",
                        "disable-funding": "venmo,paylater,card,p24"
                    }}
                >
                    <ButtonWrapper
                        currency={currency}
            ...
            {cash && (
                <OrderInfo total={cart.total} createOrder={createOrder}/>
            )}
        </div>
    )
}
